  ...
  <body>
    <?php
      ...
      while($row=mysqli_fetch_array($result))
      {
        ...
        {
          echo "<tr><td>".$row['Houseid']."</td><td>".$row['Name']."</td><td>".$row['Address']."</td><td>".$row['Area']."</td><td>".$row['BHK']."</td><td>".$row['Furnished']."</td><td>".$row['NoOfPeopleAllowed']."</td><td>".$row['MaritalStatus']."</td><td>".$row['GenderAllowed']."</td><td>".$row['Pets']."</td><td>".$row['Restrictions']."</td><td>".$row['Status']."</td><td><a href='pay.html'><button class='bn632-hover bn24'>BUY</button></a></td></tr>";
          echo "<br/>";
        }
        echo "</center>";
      }
